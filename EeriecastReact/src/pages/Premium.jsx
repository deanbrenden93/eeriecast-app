...
export function PaymentFormModal({ open, onClose, onSuccess, mode = 'trial', plan = 'monthly' }) {
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-500">
                    {mode === 'trial' ? `7-day free trial \u00b7 ${planShort} after` : 'This card will be used for future payments'}
                  </p>
                </div>
              </div>

              {/* Charge disclosure (trial mode only) */}
              {mode === 'trial' && (
